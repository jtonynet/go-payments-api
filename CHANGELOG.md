...
## [0.2.3] - 2025-12-12
### Adicionado
  - Adicionado `Grafana Loki`
  - Melhorias nos `Logs`
  - Aumento da cobertura de `Observabilidade`

## [0.2.2] - 2025-02-12
### Adicionado
  - Melhorias `PubSub` a estrutura agora é composta por sync.Map aninhados.
...
## [0.1.9] - 2024-29-12
### Adicionado
  - Nova tabela auxiliar `transactions_latest`
  - Melhorias para obter `transactions` e `balances`
  - Melhorias no `Dashboard` `Grafana`
...
[0.2.3]: https://github.com/jtonynet/go-payments-api/compare/v0.2.2...v0.2.3
[0.2.2]: https://github.com/jtonynet/go-payments-api/compare/v0.2.1...v0.2.2
